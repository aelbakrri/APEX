...
// MARK: - Typography (DM Sans)
extension Font {
    static let displayLarge  = Font.custom("DMSans-Bold",    size: 34)
    static let displayMedium = Font.custom("DMSans-Bold",    size: 28)
    static let displaySmall  = Font.custom("DMSans-Medium",  size: 22)
    static let headlineLarge = Font.custom("DMSans-Medium",  size: 18)
    static let headlineSmall = Font.custom("DMSans-Medium",  size: 15)
    static let bodyLarge     = Font.custom("DMSans-Regular", size: 16)
    static let bodySmall     = Font.custom("DMSans-Regular", size: 14)
    // Note: we intentionally skip redefining .caption (conflicts with SwiftUI built-in)
    static let label         = Font.custom("DMSans-Medium",  size: 11)
}
